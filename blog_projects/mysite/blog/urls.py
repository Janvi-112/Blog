...
urlpatterns = [
    ...
    url(r'^post/(?P<pk>\d+)$', views.PostDetailView.post_view, name='post_detail'),
    ...
    url(r'^drafts/$', views.DraftListView.draft,
        name='post_draft_list'),
    url(r'^post/(?P<pk>\d+)/comment/$',
        views.add_comment_to_post, name='add_comment_to_post'),
    url(r'^comment/post/(?P<pk>\d+)/approve/$',
        views.comment_approve, name='comment_approve'),
    url(r'^comment/post/(?P<pk>\d+)/remove/$',
